...
$total_agent_commission += $single_sold_info->total_agent_commission_amt;
$net_amt = $single_sold_info->total_bill - ($single_sold_info->total_shop_commission_amt + $single_sold_info->total_agent_commission_amt);
...
$output .="<tr>
   ...
   <td>".number_format($single_sold_info->total_shop_commission_amt, 2).'//-'."</td>
   <td>".number_format($single_sold_info->total_agent_commission_amt, 2).'//-'."</td>
    <td>".$net_amt.".//-</td>         
</tr>";
...
if($single_sold_info->due_agent_commission ==0)
{
  $show_deu = '';
   ...
   $show_deu = '+'.$single_sold_info->due_agent_commission;

   $old_due_agent_commission += $single_sold_info->due_agent_commission;
}

$agent_given_amt = $total_net_amount - ($total_agent_commission + $old_due_agent_commission);
...
<p>$total_unit জোড়া  মোজা , সর্বমোট $total_bill_amt টাকা , দোকানদারের কমিশন $total_shop_commission  টাকা , এজেন্ট  কমিশন $total_agent_commission $show_deu  টাকা , এজেন্ট দিবে  টাকা $agent_given_amt  </p>";

$grnad_total_shocks += $total_unit;
$grnad_total_bill += $total_bill_amt;
$grnad_shop_commission += $total_shop_commission;
$grnad_agent_commission += $total_agent_commission + $old_due_agent_commission;
$grand_shop_bill +=$total_net_amount;
$grand_agent_give_amt += $agent_given_amt;
...
<p> ***  $grnad_total_shocks জোড়া  মোজা , সর্বমোট $grnad_total_bill টাকা , দোকানদারের কমিশন $grnad_shop_commission টাকা , এজেন্ট  কমিশন $grnad_agent_commission  টাকা , এজেন্ট দিবে $grand_agent_give_amt টাকা ***  </p>
