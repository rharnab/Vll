...
class GlBalanceReportController extends Controller
{
    ...
    */
    public function glBalanceSheet(Request $request){
        ...
        $assets_gl_list             = $this->getAssetsGlBalance($frm_dt, $to_dt);
        $liability_gl_list          = $this->getLiabilityGlBalance($frm_dt, $to_dt);
    ...
    *
    */
    public function getAssetsGlBalance($frm, $to){
        $asset_gl_list_array = [];
        ...
        foreach($asset_root_gls as $asset_root_gl){
            $asset_gl_list_array['root_gl'][$asset_root_gl->acc_no] = [
                ...
                "balance"         => $this->accountBalanceSummation($asset_root_gl->acc_no, $frm, $to),
                "second_level_gl" => []
            ];
        }
        ...
        foreach($asset_2nd_level_gls as $asset_2nd_level_gl){
            $asset_gl_list_array['root_gl'][$asset_2nd_level_gl->mother_ac_no]['second_level_gl'][$asset_2nd_level_gl->acc_no] = [
                ...
                "balance"        => $this->accountBalanceSummation($asset_2nd_level_gl->acc_no, $frm, $to),
                "third_level_gl" => []
            ];
        }
        ...
        foreach($asset_3rd_level_gls as $asset_3rd_level_gl){
            ...
            $asset_gl_list_array['root_gl'][$mother_gl]['second_level_gl'][$asset_3rd_level_gl->mother_ac_no]['third_level_gl'][$asset_3rd_level_gl->acc_no] = [
                ...
                "balance"      => $this->accountBalanceSummation($asset_3rd_level_gl->acc_no, $frm, $to)
            ];
        }
    ...
    *
    */
    public function getLiabilityGlBalance($frm, $to){
        ...
        foreach($liability_root_gls as $liability_root_gl){
            $liability_gl_list_array['root_gl'][$liability_root_gl->acc_no] = [
                ...
                "balance"         => $this->accountBalanceSummation($liability_root_gl->acc_no, $frm, $to),
                "second_level_gl" => []
            ];
        }
        ...
        foreach($liability_2nd_level_gls as $liability_2nd_level_gl){
            $liability_gl_list_array['root_gl'][$liability_2nd_level_gl->mother_ac_no]['second_level_gl'][$liability_2nd_level_gl->acc_no] = [
                ...
                "balance"        => $this->accountBalanceSummation($liability_2nd_level_gl->acc_no, $frm, $to),
                "third_level_gl" => []
            ];
        }
        ...
        foreach($liability_3rd_level_gls as $liability_3rd_level_gl){
            ...
            $liability_gl_list_array['root_gl'][$mother_gl]['second_level_gl'][$liability_3rd_level_gl->mother_ac_no]['third_level_gl'][$liability_3rd_level_gl->acc_no] = [
                ...
                "balance"      => $this->accountBalanceSummation($liability_3rd_level_gl->acc_no, $frm, $to)
            ];
        }
    ...
    *
    */
    public function accountBalanceSummation($account_no, $frm, $to){
        $total_cr = DB::select(DB::raw("SELECT  sum(amount) as total_cr from `transaction` where acc_no ='$account_no' and trnTp ='cr' and transaction_date between '$frm' and '$to' "));
        $total_dr = DB::select(DB::raw("SELECT  sum(amount) as total_dr from `transaction` where acc_no ='$account_no' and trnTp ='dr' and transaction_date between '$frm' and '$to' "));
