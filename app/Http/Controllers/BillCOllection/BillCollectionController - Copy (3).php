    ...
    public function pay_all_due(Request $request)
    {
        ...
        foreach($monthly_due_bill as $single_monthly_due_bill){ 
            ...
            // single month bill collection section 
              ...
              echo $updateMonthBillPayment = $this->updateMonthBillPayment($rack_code, $shop_id, $year, $month, $socks_bill_no, $agent_id, $sales_quantity, $collect_amount);
...
die();
    ...
    public function updateMonthBillPayment($rack_code, $shop_id, $year, $month, $socks_bill_no, $agent_id, $sales_quantity, $collect_amount){
        $sql = "SELECT 
        ...
        $total_amount_payment = $monthly_billing_data->total_amount_payment;
        $total_shopkeeper_amount_payment = $monthly_billing_data->total_shopkeeper_amount_payment;
        $total_agent_amount_payment = $monthly_billing_data->total_agent_amount_payment;
        $total_venture_amount = $monthly_billing_data->total_venture_amount;
        ...
        $old_total_amount_payment = $old_bill_payment_data[0]->total_amount_payment;
        $old_total_shopkeeper_amount_payment = $old_bill_payment_data[0]->total_shopkeeper_amount_payment;
        $old_total_agent_amount_payment = $old_bill_payment_data[0]->total_agent_amount_payment;
        $old_total_venture_amount_payment = $old_bill_payment_data[0]->total_venture_amount_payment;
        ...
        DB::table('commissions')->insert([
            ...
            "agent_commission_amount"     => $total_agent_amount_payment,
            "venture_amount"              => $total_venture_amount,
            "old_agent_commission"        => $old_total_agent_amount_payment,
            "old_shop_commission"         => $old_total_shopkeeper_amount_payment,
            "old_venture_commission"      => $old_total_venture_amount_payment,
            "entry_user_id"               => Auth::user()->id,
            "billing_year_month"          => $billing_year_month,
            "entry_datetime"              => date('Y-m-d H:i:s')
        ]);
        ...
        $sql = "SELECT 
         ...
         foreach($monthly_due_bill as $single_monthly_due_bill){ 
            ...
            // single month bill collection section 
              ...
              $updateMonthBillPayment = $this->updateMonthBillPayment($rack_code, $shop_id, $year, $month, $socks_bill_no, $agent_id, $sales_quantity, $collect_amount);
