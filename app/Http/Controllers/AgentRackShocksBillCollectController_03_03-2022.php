...
class AgentRackShocksBillCollectController extends Controller
{
    public function billCollect(Request $request){
        ...
        if($request->has('shocks')){
            ...
            /*--------------shocks commission ------------------------*/
             $socks_commission_updated = $this->updateScoksCommission($rack_code, $shop_id, $sold_date);
    ...
    public function updateScoksCommission($rack_code, $shop_id, $bill_date)
    {
        ...
        $commissions      = $this->getTotalShocksCommissions($total_monthly_sales_count, $shop_id);
        ...
        $sql = "UPDATE rack_products set
                    shop_commission = (selling_price / 100)* $shop_commission_parcent, 
                    venture_amount = (selling_price / 100)* $venture_commission_parcent,
                    agent_commission = (selling_price / 100)* $agent_commission_parcent            
                where
                   rack_code = '$rack_code' 
                   and shop_id = '$shop_id' 
                   and status in   (1, 3)
    ...
    public function pdfHTML($rack_code){
        ...
        th, td {
          ...
          <h2 style='text-align:center;'>আলনার  বিল ভাউচার</h2>
    <table>
        <tr>
...
<br>
<p>১০ জোড়া  মোজা , সর্বমোট ৫০০ টাকা , দোকানদারের কমিশন ১০০ টাকা , দোকানদার দিবে ৪০০ টাকা </p>   
<br>
<br>
<br>
