...
class BillPaymentAuthorizeController extends Controller
{
   ...
   public function show_details(Request $request){
     ...
     $agent_user = DB::table('users')->whereIn('role_id', [2,8])->get();
       ...
       return view('bill_authorize.show_details', compact('get_data_shocks_bill','get_single_commission_data', 'billing_month','conveynce_bill_parameter','agent_user', 'get_user_data', 'is_agent_convence_pay'));
