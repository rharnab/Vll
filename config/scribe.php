...
return [
     ...
     */
    'title' => 'VLL Mobile Application API',

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'This api documentation for shurovi mobile application development',

    /*
     * The base URL displayed in the docs. If this is empty, Scribe will use the value of config('app.url').
     */
    'base_url' => 'http://localhost/pegasus-socks/',
    /*
...
INTRO
     ...
     *
     */
    'logo' => 'http://venturelifestylelimited.com/public/backend/assets/img/vll.png', // for `laravel` type
