...
<div class="subheader">
        <h1 class="subheader-title">            
            ...
            <span style="float:right">
                <a href="{{route('parameter_setup.client.create')}}" class="btn btn-sm btn-primary">
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped table-sm w-100">
                                                ...
                                                <tbody>
                                                     ...
                                                     @php $sl=1; @endphp
                                                    @foreach($all_client as $single_info)
                                                    
                                                    <tr>
                                                        <td>{{$sl++}}</td>    
                                                        <td>{{$single_info->client_name}}</td>    
                                                        <td>{{$single_info->contact_no}}</td>    
                                                        <td>{{$single_info->address}}</td>    
                                                        
                                                        <td><a href="{{ route('parameter_setup.client.edit',Crypt::encrypt($single_info->id )) }}" class="btn btn-info btn-sm">Edit</a></td>
                                                    </tr>
