                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form id="" action="{{ route('parameter_setup.racks.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                      <label class="form-label" for="rack_code">Rack Code</label>
                                          
                                         <input value="{{ $rack_info->rack_code }}" type="text" name="rack_code" class="form-control">
                                ...
                                <div class="form-row">
                                      ...
                                      <div class="col-md-12 mb-3">
                                        <label class="form-label" for="code">Total Count</label>
                                           ...
                                           <input value="{{ $rack_info->total_count }}" type="text" name="total_count" class="form-control">
                                ...
                                <input type="hidden" value="{{ Crypt::encrypt($rack_info->id) }}" name="edit_id">
