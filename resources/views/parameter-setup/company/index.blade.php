...
<div class="subheader">
        <h1 class="subheader-title">            
            ...
            <span style="float:right">
                <a href="{{route('parameter_setup.company.create')}}" class="btn btn-sm btn-primary">
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped table-sm w-100">
                                                ...
                                                <tbody>
                                                     ...
                                                     @php $sl=1; @endphp
                                                    @foreach($companies as $single_info)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$single_info->user_name}}</td> 
                                                        <td><a href="{{ route('parameter_setup.company.edit',Crypt::encrypt($single_info->id )) }}" class="btn btn-info btn-sm">Edit</a></td>
                                                    </tr>
