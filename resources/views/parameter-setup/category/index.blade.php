...
<div class="subheader">
        <h1 class="subheader-title">            
            ...
            <span style="float:right">
                <a href="{{route('parameter_setup.category.create')}}" class="btn btn-sm btn-primary">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped table-sm w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ route('parameter_setup.category.edit',Crypt::encrypt($single_info->id )) }}" class="btn btn-info btn-sm">Edit</a></td>
                                                    </tr>
