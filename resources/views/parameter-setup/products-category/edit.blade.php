...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">Product Categories Edit Form</li>
        ...
        <div class="row">
            <div class="col-xl-6 col-md-6 ">
                <div id="panel-3" class="panel">
                    <div class="panel-hdr">
                        <h2>Product Categories Edit Form</h2>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form id="" action="{{ route('parameter_setup.product_categories.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="starting_amt" value="{{$get_data->starting_amt}}" class="form-control" required>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                       ...
                                       <input type="text" name="ending_amt" value="{{$get_data->ending_amt}}" class="form-control" required>
                                ...
                                <div class="form-row">
                                      ...
                                      <div class="col-md-12 mb-3">
                                        <label class="form-label" for="code">short code</label>
                                           ...
                                           <input type="text" name="short_code" value="{{$get_data->short_code}}" class="form-control" required>
                                 ...
                                 <div class="form-row">
                                      ...
                                      <div class="col-md-12 mb-3">
                                        <label class="form-label" for="code">Full Name</label>
                                           ...
                                           <input type="text" name="full_name" class="form-control"  value="{{$get_data->full_name}}" required>
