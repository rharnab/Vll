        ...
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-xs-2">
                        <div class="row">
                                <div class="col-md-8">
                                    <h2 class="count_text"> <span class="text-uppercase text-dark font-weight-bold"> Socks  Refill</span></h2>
                                </div>
                                <div class="col-md-4">
                    ...
                    <div class="col-md-2 col-xs-2">
                        <div class="row">
                                <div class="col-md-8">
                                    <h2 class="count_text"> <span class="text-uppercase text-dark font-weight-bold"> T-Shirt Refill  </span></h2>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="count_text"> <span class="text-uppercase text-danger float-right count bg-dark "> {{ 0 }} </span></h2>
                                </div>
                        </div>
                    </div>
                     {{-- end  tshirt  rack due --}}
                    ...
                    <div class="col-md-2 col-xs-2">
                        <div class="row">
                                <div class="col-md-8">
                                    <h2 class="count_text"> <span class="text-uppercase text-dark font-weight-bold">Socks Rack  </span></h2>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="count_text"> <span class="text-uppercase text-danger float-right count bg-dark "> {{ $socks_rack[0]->total_socks_rack }} </span></h2>
                                </div>
                        </div>
                    </div>
                     {{-- end  tshirt  rack due --}}
                    ...
                    <div class="col-md-2 col-xs-2">
                        <div class="row">
                                <div class="col-md-8">
                                    <h2 class="count_text"> <span class="text-uppercase text-dark font-weight-bold">Combine Racks  </span></h2>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="count_text"> <span class="text-uppercase text-danger float-right count bg-dark"> {{ $combine_racks[0]->total_combine_racks }} </span></h2>
                                </div>
                        </div>
                    </div>
                     {{-- end  tshirt  rack due --}}
                    ...
                    <div class="col-md-2 col-xs-2">
                        <div class="row">
                                <div class="col-md-8">
                                    <h2 class="count_text"> <span class="text-uppercase text-dark font-weight-bold">Close Shop  </span></h2>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="count_text"> <span class="text-uppercase text-danger float-right count bg-dark"> {{ $close_shop }} </span></h2>
                                </div>
                        </div>
                    </div>
                     {{-- end  tshirt  rack due --}}
                ...
                <table
                    ...
                    <thead class="bg-primary-600">
                        <tr class="bg-dark text-uppercase font-weight-bold">
                            <th colspan="6"> Previous  Due Shop List</th>
                    ...
                    <tbody>
                       ...
                       <tr >
                            ...
                            <td>{{ ($single_result->shop_area)? $single_result->shop_area : ''}}</td>
            ...
            <div class="col-md-6 col-xs-6 mt-4">
                <table
                    ...
                    <thead class="bg-primary-600">
                        <tr class="bg-dark text-uppercase font-weight-bold">
                            <th colspan="4"> socks need Refill </th>
                    ...
                    <tbody>
                        ...
                        @foreach($refill_result as $single_result)
                           <tr>
                                <td>{{ $sl++ }}</td>
                                <td onclick="ShowDetails(' {{ $single_result->shop_id }}', '{{ $single_result->rack_code }}')">{{ $single_result->shop_name}}</td>
                                 <td>{{ $single_result->shop_area}}</td>
                               
                                    
                                @if($single_result->refill_first == '1000') 
                                    <td style="text-decoration:underline;cursor:pointer;color:red" onclick="show_socks('{{ $single_result->rack_code}}')">{{ $single_result->rack_code}}</td>
                                @else
                                    <td style="text-decoration:underline;cursor:pointer;" onclick="show_socks('{{ $single_result->rack_code}}')">{{ $single_result->rack_code}}</td>
                                @endif
            ...
            <div class="col-md-6 col-xs-6 mt-4">
                <table
                    ...
                    <thead class="bg-primary-600">
                        <tr class="bg-dark text-uppercase font-weight-bold">
                            <th colspan="4"> T-Shirt need Refill </th>
            ...
            $.ajax({
               ...
               beforeSend: function()
                ...
                success:function(data)
                {
                    ...
                    {
                        $('#contact').html(data.contact_no+'/'+data.owner_contact);
