            ...
            <div class="col-xl-12">
                <!-- data table -->
                 <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                        <h2>
                                               <span class="text-capitalize">{{ $type }}</span> &nbsp; Details
                                        </h2>
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped table-sm w-100">
                                                ...
                                                <tbody>
                                                    @php $sl=1; @endphp
                                                    @foreach($result_info as $single_info)
                                                       <tr>
                                                           <td>{{ $sl++ }}</td>
                                                         <td>{{ $single_info->shop_name }}</td>
                                                         <td>{{ $single_info->rack_code }}</td>
                                                         <td>{{ $single_info->total_socks }} Pair</td>
                                                         <td>{{ $single_info->shop_address }}</td>
                                                         <td>{{ $single_info->manager_name }}</td>
                                                         <td>{{ $single_info->contact_no }}</td>
                                                         <td>{{ $single_info->agent_name }}</td>
