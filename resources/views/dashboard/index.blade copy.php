...
<div class="panel-container show">
    <div class="panel-content">
        ...
        <div class="row">
            ...
            <div class="col-sm-2 col-xl-2 offset-8">
        ...
        <div class="row">
            <!--  Due Bill Collection  -->
            <div class="col-md-6">
                <h2> <span class="text-uppercase text-danger font-weight-bold">Due shop  </span></h2>
                <hr class="bg-danger">
                <table
            ...
            <!--  Rack Refill  -->
            <div class="col-md-6">
                <h2> <span class="text-uppercase text-danger font-weight-bold">Refill Shop  </span></h2>
                <hr class="bg-danger">
                <table
                    class="table table-bordered table-hover table-striped table-sm w-100 dataTable bg-danger text-white">
                    <thead class="bg-primary-600">
