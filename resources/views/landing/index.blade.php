                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12">
                            <div class="card" style="border-radius: 10px; height: auto">
                              <div class="card-body">
                                ...
                                <h2 class="text-danger responsive_h2" style="text-align:center; color: #ff0000; font-weight: bold; font-size: 1.3rem; "> ঈদ উৎসবে বিক্রেতা ভাইদের জন্য বিশেষ অফার ! ! ! </h2>
                               ...
                               <br>
                                ...
                                <br>
                                 ...
                                 <table class="table table-bordered text-center" style="font-size: 0.9rem; background-color: #27a7e236;">
                                    <tr >
                                         <td  rowspan="2" width="200px"> <span class="mt-4" style="display: block;">বিক্রেতাদের 
<b> T-shirt / Polo shirt / Pant-Gabadine </b> বিক্রিতে শতকরা লাভের পরিমাণ </span> </td>
                                        <td width="100">১-২০ টি </td>
                                        <td width="100">২১-৩০ টি  </td>
                                        <td width="100">৩১ টি এবং তার অধিক </td>
                                    </tr>


                                    <tr>
                                        
                                        <td class="text-center"><b>১৫% </b></td>
                                        <td class="text-center"><b>১৮% </b></td>
                                        <td class="text-center"><b>২০%</b></td>
                                    </tr>
                                </table>
