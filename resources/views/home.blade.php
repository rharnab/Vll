...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-sm-2 col-xl-2">
            <a href="{{ route('dashboard.report.rack', [date('Y-m', strtotime('-1 month', strtotime(date('Y-n-j')) ))]) }}" target="_blank">
        ...
        <div class="col-sm-2 col-xl-2">
            <a href="{{ route('dashboard.report.socks_bill', [date('Y-m', strtotime('-1 month', strtotime(date('Y-n-j')) ))]) }}" target="_blank">
                <div class="p-3 bg-primary-300 rounded overflow-hidden position-relative text-white mb-g text-center">
                    <div class="">
                        <h3 class="display-4 d-block l-h-n m-0 fw-500">
                            <span class="amount_area"> {{ ($last_month_sale_socks_amt[0]->last_month_sale_socks_amt)? number_format($last_month_sale_socks_amt[0]->last_month_sale_socks_amt, 2): 0  }} <i class="fa fa-long-arrow-alt-right"></i></span>
                            <small class="m-0 l-h-n">Last Month socks Bill </small>
                        </h3>
                    </div>
        ...
        <div class="col-sm-2 col-xl-2">
            <a href="{{ route('dashboard.report.pant_bill', [date('Y-m', strtotime('-1 month', strtotime(date('Y-n-j')) ))]) }}" target="_blank">
                <div class="p-3 bg-primary-300 rounded overflow-hidden position-relative text-white mb-g text-center">
                    <div class="">
                        <h3 class="display-4 d-block l-h-n m-0 fw-500">
                            <span class="amount_area"> {{ ($last_month_sale_pant_amt[0]->last_month_sale_pant_amt)? number_format($last_month_sale_pant_amt[0]->last_month_sale_pant_amt, 2): 0  }} <i class="fa fa-long-arrow-alt-right"></i></span>
                            <small class="m-0 l-h-n">Last Month Pant <br> Bill </small>
                        </h3>
                    </div>
        ...
        <div class="col-sm-2 col-xl-2">
            <a href="{{ route('dashboard.report.tshirt_bill', [date('Y-m', strtotime('-1 month', strtotime(date('Y-n-j')) ))]) }}" target="_blank">
                <div class=" p-3 bg-warning-400 rounded overflow-hidden position-relative text-white mb-g text-center">
                    <div class="">
                        <h3 class="display-4 d-block l-h-n m-0 fw-500">
                            <span class="amount_area"> {{ ($last_month_sale_tshirt_amt[0]->last_month_sale_tshirt_amt)? number_format($last_month_sale_tshirt_amt[0]->last_month_sale_tshirt_amt, 2): 0  }} <i class="fa fa-long-arrow-alt-right"></i> </span>
                            <small class="m-0 l-h-n">Last Month T-shirt Bill </small>
                        </h3>
                    </div>
                    <i class="fa fa-tshirt position-absolute pos-right pos-bottom opacity-15  mb-n1 mr-n4" style="font-size: 6rem;"></i>
                </div>
        ...
        <div class="col-sm-2 col-xl-2">
            <a href="{{ route('dashboard.report.socks_bill', date('Y-m')) }}" target="_blank">
                <div class=" p-3 bg-success-200 rounded overflow-hidden position-relative text-white mb-g text-center">
                    <div class="">
                        <h3 class="display-4 d-block l-h-n m-0 fw-500">


                            <span class="amount_area"> {{ ($this_month_sale_socks_amt[0]->this_month_sale_socks_amt)? number_format($this_month_sale_socks_amt[0]->this_month_sale_socks_amt, 2): 0  }} <i class="fa fa-long-arrow-alt-right"></i> </span>


                            <small class="m-0 l-h-n">This Month socks Bill </small>
                        </h3>
                    </div>
                    <i class="fas fa-socks position-absolute pos-right pos-bottom opacity-15 mb-n5 mr-n6" style="font-size: 8rem;"></i>
                </div>
        ...
        <div class="col-sm-2 col-xl-2">
            <a href="{{ route('dashboard.report.pant_bill', date('Y-m')) }}" target="_blank">
                <div class="p-3 bg-danger-200 rounded overflow-hidden position-relative text-white mb-g text-center">
                    <div class="">
                        <h3 class="display-4 d-block l-h-n m-0 fw-500">

                            <span class="amount_area"> {{ ($this_month_sale_pant_amt[0]->this_month_sale_pant_amt)? number_format($this_month_sale_pant_amt[0]->this_month_sale_pant_amt, 2): 0  }} <i class="fa fa-long-arrow-alt-right"></i> </span>

                            <small class="m-0 l-h-n">This Month Pant <br> Bill </small>
                        </h3>
                    </div>
                    <i class="fas fa-socks position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4" style="font-size: 6rem;"></i>
                </div>
        ...
        <div class="col-sm-2 col-xl-2">
            <a href="{{ route('dashboard.report.tshirt_bill', date('Y-m')) }}" target="_blank">
                <div class="p-3 bg-primary-200 rounded overflow-hidden position-relative text-white mb-g text-center custom_height">
                    <div class="">
                        <h3 class="display-4 d-block l-h-n m-0 fw-500">
                            <span class="amount_area"> {{ ($this_month_sale_tshirt_amt[0]->this_month_sale_tshirt_amt)? number_format($last_month_sale_tshirt_amt[0]->last_month_sale_tshirt_amt, 2): 0  }} <i class="fa fa-long-arrow-alt-right"></i> </span>
                            <small class="m-0 l-h-n">This Month T-shirt Bill </small>
                        </h3>
                    </div>
                    <i class="fa fa-tshirt position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4" style="font-size: 6rem;"></i>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- @if($sales->total_due_sold  == 0)
                                                        ...
                                                        @endif-->
                                        @if(empty($sales->last_sales_update_date))
                                        -
                                        @else
                                        {{ date('d/m/Y', strtotime($sales->last_sales_update_date)) }}
                                        @endif
                                    ...
                                    <td>{{ $sales->socks_commission }} </td>
                                    <td>{{ $sales->tshirt_commission }} </td>
                                    <td>{{ $sales->pant_commission }} </td>
