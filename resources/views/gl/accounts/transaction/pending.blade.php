...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">Pending Transaction List</li>
            ...
            <div class="col-xl-12 col-md-12">
                <!-- data table -->
                 <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                     <h2>Authorization Pending Transaction List</h2>
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            ...
                                            <!-- datatable start -->
                                            <table class="table table-bordered table-hover m-0" style="width:100%; overflow-x: scroll;" id="dt-basic-example">
                                                ...
                                                <tbody>
                                                	...
                                                	@foreach($transactions as $single_data)
                                                	...
                                                	<tr>
                                                        ...
                                                        <input type="checkbox"  value="{{ $single_data->batch_no}}" name="batch_no[]"> 
                                                            {{ $sl++ }}</td>
                                                		<td>{{ $single_data->dr_ac }} <br> ({{ $single_data->dr_acc }})</td>   
                                                                                                        
                                                        <td>{{ $cr_info[1] }} <br> ({{ $cr_info[0] }})</td>
                                                        
                                                        <td>{{ str_replace('-','', number_format($single_data->dr_amount, 2)) }} TK</td>
     ...
     $('.authBtn').click(function(){
        ...
        cuteAlert({
            ...
            if (e == ("confirm")){
                $.ajax({
                    type: 'POST',
                    url: '{{ route('gl.account.transaction.authorize') }}',
     ...
     $('.decline').click(function(){
        ...
        cuteAlert({
            ...
            if (e == ("confirm")){
                $.ajax({
                    type: 'POST',
                    url: '{{ route('gl.account.transaction.decline') }}',
                    data: { batch_no : batch_no,  "_token": "{{ csrf_token() }}" },
                    beforeSend: function() {
                        loaderStart();
                    },
