...
<main id="js-page-content" role="main" class="page-content p-0">
    ...
    {
    	 $monther_balance = DB::table('gl_accounts')->where('mother_ac_no', $acc_no)->sum('gl_bal');
    	 if(empty($monther_balance))
    	 {
    	 	 $monther_balance = DB::table('gl_accounts')->where('acc_no', $acc_no)->sum('gl_bal');
    	 ...
    	 return number_format($monther_balance, 2);
    }
                                        ...
                                        <li class="list-group-item node-treeview1 bg-danger text-white font-weight-bold" data-nodeid="1">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 text-right">
                                                  ...
                                                  @php 
                                                   $gnrand_blance  = DB::table('gl_accounts')->where('asset_liability_status', 0)->sum('gl_bal');                                        
                                                    @endphp

                                                     {{ ($gnrand_blance) ? number_format($gnrand_blance, 2): 0.00 }} /= Tk
                                        ...
                                        <li class="list-group-item node-treeview1 bg-danger text-white font-weight-bold" data-nodeid="1">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 text-right">
                                                    ...
                                                    @php 
                                                   $gnrand_blance  = DB::table('gl_accounts')->where('asset_liability_status', 1)->sum('gl_bal');
                                                    @endphp
                                                    {{ ($gnrand_blance) ? number_format($gnrand_blance, 2): 0.00 }} /= tk
