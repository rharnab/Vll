...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active"> Factory  Voucher List </li>
                ...
                <!-- data table -->
                 <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                       ...
                                       <h2> Factory  All Authorize List  </h2>
                                            ...
                                            <table class="table table-bordered table-hover table-striped table-sm w-100 text-center dataTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a target="_blank" class="btn btn-warning btn-sm"" href="{{ route('factory.bill.show_voucher', Crypt::encrypt($single_data->id)) }}">Voucher</a></td>
                                                    </tr>
