@extends('layouts.app')
@section('title','Factory  Bill Payment')
...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">Factory Bill Payment</li>
                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form id="" action="{{ route('factory.bill.bill_store') }}" method="post" enctype="multipart/form-data" >
    ...
    <script>
        $('#client_id').on('change', function(){
            ...
            {   
                ...
                $.ajax({
                    type:"POST",
                    url:"{{ route('factory.bill.challan_no') }}",
                    data:{
                        client_id: client_id,
                        "_token": " {{ csrf_token() }} ",
                    },
       ...
       var challan_no = $("#challan_no").val();
        ...
        $.ajax({
                ...
                success:function(data)
                {
                    ...
                    $("#total_amount").val(json_data.total_buy_amt);
                    $("#paid_amount").val(json_data.total_buy_paid_amt);
                    $("#due_amount").val(json_data.total_buy_due_amt);
...
<script>
    ...
    //    alert(bill_collection_amount);
        ...
        if(bill_collection_amt > due_amt){
            ...
            if ( e == ("confirm")){
                ...
                $.ajax({
                type:"POST",
                url:"{{ route('factory.bill.bill_store') }}",
                data:{
                    challan_no: challan_no,
     ...
     <script>
        ...
        var inWords = function(totalRent){
            ...
            // Call conver amount in words funcion
                document.getElementById('bill_collection_amount').onkeyup = function () {
                document.getElementById('amount_in_word').innerHTML = inWords(document.getElementById('bill_collection_amount').value);
            };
    ...
    <script>
        $('#bill_collection_amount').keyup(function(){
            var amount = $('#bill_collection_amount').val();
            if($.isNumeric(amount) == false)
            {
                $('#amount_in_word').html("Please give only number")
            }
