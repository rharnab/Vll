@extends('layouts.app')
@section('title',' Authorize Corporate Bill')
...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active"> Authorize Corporate Bill </li>
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td>
                                                          @if($single_get_data->status=='0')
                                                              <a  href="{{ url('corporate/bill/bill_authorize') }}/{{$single_get_data->id}}" class="btn btn-primary btn-sm" >Authorize</a></td>
                                                          @endif
                                                        </tr>
