...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active"> Rack  Report </li>
                ...
                <!-- data table -->
                 <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                       ...
                                       <h2> Rack information for  This month Rack </h2>
                                        @else
                                        <h2> Rack information for  Last month Rack </h2>
                                        @endif
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <table class="table table-bordered table-hover table-striped table-sm w-100 text-center dataTable">
                                                ...
                                                <tbody>
                                                	...
                                                	$sl=1;
                                                	@endphp
                                                    @foreach($this_month_rack_reuslt as $single_result)
                                                    <tr>
                                                        <td>{{ $sl++ }}</td>
