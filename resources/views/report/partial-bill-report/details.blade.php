                                                ...
                                                <tbody>
                                                   ...
                                                   @foreach($get_data as $single_data)
                                                    <tr>
                                                        ...
                                                        <td>{{$single_data->bill_no}}</td>
                                                        <td>{{$single_data->total_socks}}</td>
                                                        <td>{{ number_format($single_data->venture_amt, 2) }}</td>
                                                        <td>{{ number_format($single_data->paid_amt, 2) }}</td>
                                                        <td>{{ number_format($single_data->total_paid, 2) }}</td>
                                                        <td>{{ number_format($single_data->convence_amt,2) }}</td>
                                                        <td>{{ number_format($single_data->total_convence,2) }}</td>
