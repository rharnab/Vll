                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form id="" action="{{ route('report.socks_return_report.show') }}" method="post" enctype="multipart/form-data" target="_blank">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select class="form-control select2" onchange="get_shop_id(this.value)" name="shop_id" >
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select class="form-control select2 select_rack" name="rack_code" >
