...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">User Wise Activity Report</li>
        ...
        <div class="row">
            <div class="col-xl-6 col-md-6 ">
                <div id="panel-3" class="panel">
                    <div class="panel-hdr">
                        <h2>User Wise Activity Report</h2>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form  action="{{ route('report.user_wise_activity.summary') }}" method="post" enctype="multipart/form-data" target="_blank">
