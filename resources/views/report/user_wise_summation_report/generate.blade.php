...
=======
                                                            $total_venture_amt += $data->total_venture_amt;
>>>>>>> f5637a8a2e693190d55ebcb37c9bb60af5a77d00
                                                        @endphp
                                                        <tr>
                                                            <td>{{$sl++}}</td>
                                                            <td>{{$data->operation_user_name}}</td>
...
<<<<<<< HEAD
=======
                                                            <td>{{ ($data->total_venture_amt) ?  number_format($data->total_venture_amt, 2) : '-'}}</td>
>>>>>>> f5637a8a2e693190d55ebcb37c9bb60af5a77d00
...
=======
                                                        <th>{{ number_format($total_sell, 2) }}</th>
                                                         <th>{{ number_format($total_venture_amt, 2) }}</th>
>>>>>>> f5637a8a2e693190d55ebcb37c9bb60af5a77d00
