...
<body>
   ...
   <h4>Shop Name : <?php echo $shop_info->shop_name; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Contact No : <?php echo $shop_info->contact_no; ?> &nbsp;&nbsp; Address : <?php echo $shop_info->address; ?></h4>

<h4 style="" class="devider">Rack Code : 
    <?php echo $rack_no; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Refil No : <?php echo $refill_count; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Date : <?php echo $date; ?></h4>
       ...
       <?php 
            ...
            for($i=0; $i<count($get_data); $i++){
                ...
                if(!empty($shop_socks_code)){
                    $finally_shop_socks_code = "<td style='text-align:center;font-weight:bold;padding-top:3px;
                    padding-bottom:3px;
                    padding-left:10px;
                    padding-right:10px;'>
                    <p style='font-size:22px;'>".$shop_socks_code."</p>
                    <p class='undersockscode'  style='font-size: 12px' >
                        $short_code-$print_shocks_code
                    </p>";
                }else{
                    $finally_shop_socks_code = "<td style='text-align:center;font-weight:bold;  padding-top:15px;
                    padding-bottom:15px;
                    padding-left:15px;
                    padding-right:15px;'>
