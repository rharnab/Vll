                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped table-sm w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if(!empty($single_report_data->shop_socks_code))
                                                                {{$single_report_data->shop_socks_code}}
                                                            @else
                                                                {{$single_report_data->printed_socks_code}}
                                                            @endif
                                                        </td>

                                                        <td>{{$single_report_data->printed_socks_code}}</td>
                                                        <td>{{ number_format($single_report_data->buying_price, 2)}}</td>
                                                        <td>{{number_format($single_report_data->selling_price, 2) }}</td>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th></th>           
                                                        <th></th>
                                                        <th>{{ number_format($summation[0]->total_buy_price, 2) }}</th>
                                                        <th>{{ number_format($summation[0]->total_sale_price, 2) }}</th>
                                                        <th>entry_date</th>
