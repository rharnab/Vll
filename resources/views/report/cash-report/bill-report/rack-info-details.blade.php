            ...
            <div class="col-xl-12 col-md-12 ">
                <div id="panel-3" class="panel">
                    <div class="panel-hdr">
                        ...
                        @endphp
                        <h2>Bill Summary Report  [ <span class="font-weight-bold text-danger p-1">{{ $status_type }}</span> ] Billing Month : [ <span class="text-danger m-2">  {{ date('M-Y', strtotime($sold_date)) }}  </span> ] Agent Name : [ <span class="text-danger m-2">{{$agent_name }}</span> ] Shop Name : [ <span class="text-danger m-2">{{ $shop_name }}</span> ]</h2>
