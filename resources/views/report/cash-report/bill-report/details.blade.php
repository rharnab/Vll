                                            ...
                                            <table  class="table table-bordered table-hover table-striped table-sm w-100 text-center dataTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $sl++ }}</td>
                                                        <td>{{ ($single_result->auth_dateTime)? date('M-Y', strtotime($single_result->auth_dateTime)): '' }}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form method="post" action="{{ route('report.cash_report.rack_details') }}" target="_blank">
                                                                ...
                                                                @if($status == 7)
                                                                <input type="hidden" id="sold_date" name="sold_date" value="{{ $single_result->auth_dateTime }}">
                                                                @else
