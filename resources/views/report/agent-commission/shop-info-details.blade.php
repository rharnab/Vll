            ...
            <div class="col-xl-12 col-md-12">
                <!-- data table -->
                 <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                     <h2> Agent Commission Report  Date : [ <span class="text-danger m-2"> {{ $frm_date }} TO {{ $to_date }} </span> ] Agent Name : [ <span class="text-danger m-2">{{ $agent_name }}</span> ] </h2>
                                            ...
                                            <table class="table table-bordered table-hover table-striped table-sm w-100 text-center dataTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ date('M-Y', strtotime($single_result->sold_year_month)) }}</td>
