                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 mb-3 select_2_error">
                                        ...
                                        <input type="text" class="form-control" readonly   value="{{ $employee_salary_info->name }}">
                                        
                                        <input type="hidden" value="{{  Crypt::encrypt($employee_salary_info->employee_id) }}" name="employee_id" id="employee_id" required>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" placeholder="present Salary" value="{{ $employee_salary_info->present_salary }}"  name="present_salary"  id="present_salary"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" placeholder="Amount" name="increment_salary" value="{{ $employee_salary_info->increment_salary }}" id="increment_salary"
                                            class="form-control" onblur="checkIncrementSalary()"  required>
                                        <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="date" name="effective_date" class="form-control" id="effective_date" value="{{ $employee_salary_info->effective_date }}" required>
                                        <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" placeholder="Remarks" name="remarks" id="remarks" class="form-control" id="remarks" value="{{ $employee_salary_info->remarks }}" required>
                                        <div class="valid-feedback"></div>
                                ...
                                if (data.status == 200) {
                                    cuteAlert({
                                        ...
                                        , buttonText: "ok"
                                         ...
                                         window.location.href= "{{ route('salary.setup.index') }}";
                                    });
