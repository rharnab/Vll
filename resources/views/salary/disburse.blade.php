                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 mb-3 select_2_error">
                                        ...
                                        <select class="form-control select2" name="employee_id" id="employee_id" required>
                                            ...
                                            @foreach($all_salary as $single_data)
                                            <option value="{{ $single_data->employee_id }}"> {{ $single_data->name }} </option>
                                            @endforeach
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label class="form-label" for="disburse_month"> Last Disburse Month </label>
                                         <span id="lastPaidMonth" class="form-control text-danger font-weight-bold"></span>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text"  name="disburse_month" placeholder="MM/YYYY" onchange="monthWiseSalary()" class="form-control" id="disburse_month" required>
                                        <div class="valid-feedback"></div>
                                    </div>

                                    <div class="col-md-12 mb-3">
                                        <label class="form-label" for="total_salary">Monthly  Salary </label>
                                        <input type="text" placeholder="Total Salary" id="total_salary" name="monthly_salary"   class="form-control"  readonly>
                                        <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" placeholder="Salary Amount" name="salary_amount" id="salary_amount"  class="form-control"  readonly>
                                        <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" placeholder="Disburse Amount"  name="disburse_amount" id="disburse_amount" class="form-control"   required>
                                        <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" placeholder="Remarks" name="remarks" id="remarks" class="form-control" id="remarks" >
                                        <div class="valid-feedback"></div>
            ...
            , submitHandler: function(form) {
                cuteAlert({
                    ...
                    if (e == ("confirm")) {
                        $.ajax({
                            type: 'POST'
                            , url: '{{ route('salary.disburse.success') }}'
                            , data: $(form).serialize()
                            , beforeSend: function() {
                                loaderStart();
                            }
...
<script>
    $('#employee_id').change(function(){
        ...
        if(employee_id !='')
        {
            monthWiseSalary() // recale disburse month
            ...
            $.ajax({
                type:'post',
                url: "{{ route('salary.disburse.getSalaryInfo') }}",
                data:{employee_id},
                success:function(data)
                {
                    if(data !=''){
                        $('#lastPaidMonth').html(data)
                    }else{
                        $('#lastPaidMonth').html('')
                    }
                    console.log(data)
    ...
    //month wise salary info get

    function monthWiseSalary()
    {

        var disburse_month = $('#disburse_month').val();
        var employee_id = $('#employee_id').val();
        
        if(disburse_month !='' && employee_id !='')
        {
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $.ajax({
                type:'post',
                url: "{{ route('salary.disburse.getMonthwiseSalary') }}",
                data:{disburse_month, employee_id},
                success:function(data)
                {
                    if(data.monthly_salary !=''){
                        $('#total_salary').val(data.monthly_salary);
                        document.getElementById('total_salary_in_word').innerHTML = inWords(document.getElementById('total_salary').value);
                    }
                   
                    if(data.salary_amount > 0){

                        $('#salary_amount').val(data.salary_amount);
                        document.getElementById('salary_amount_in_word').innerHTML = inWords(document.getElementById('salary_amount').value);
                        ...
                        cuteAlert({
                                type      : "warning",
                                title     : "Warning",
                                message   : 'Sorry this month salary already paid or  panding',
                                buttonText: "ok"
                        });
                        $('#salary_amount').val(0);
                        return false;
