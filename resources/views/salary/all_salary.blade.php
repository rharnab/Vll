...
<div class="subheader">
        <h1 class="subheader-title">            
            ...
            <span style="float:right">
                <a href="{{route('salary.disburse.create')}}" class="btn btn-sm btn-primary">
                    <span class="fal fa-plus mr-1"></span> Add New Salary
                </a>
            </span>
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped table-sm w-100 text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $single_data->present_salary }}</td>
                                                        <td>{{ $single_data->increment_salary }}</td>
                                                        <td>{{ $single_data->effective_date }}</td>
                                                        <td><a href="{{ route('salary.setup.edit',Crypt::encrypt($single_data->employee_id )) }}" class="btn btn-info btn-sm">Edit</a></td>
                                                    </tr>
