                                                ...
                                                <tbody>
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td>{{$single_data->total_collect_amt}}</td>
                                                          <td>{{$single_data->total_collect_amt - $single_data->total_shop_commission}}</td>
                                                          <td>{{ $single_data->total_collect_amt- ($single_data->total_shop_commission + $single_data->total_paid_amt) }}</td>

                                                         <td style="width:12%;">
                                                         <a   href="{{url('bill-authorize/show-details')}}/{{$single_data->shocks_bill_no}} " class="btn btn-warning btn-sm">Show Details</a>    
