...
<div class="row">
    <div class="col-md-12">
        <h4 style="text-transform: uppercase; font-weight:bold; text-align:center">           
            <i class="fal fa-shopping-bag"></i> &nbsp; {{ Auth::user()->name }} ( {{ Auth::user()->role->name }} ) ( 
                <?php 
            
               if(isset($rack_info[0]->rack_code)){
                echo $rack_info[0]->rack_code;
               }  
...
<div class="row" id="socks_sections">
    ...
    <input type="hidden" id="rack_code" value="<?php 
    ...
    <input type="hidden" id="shop_id" value="
            <?php 
                ...
                if(isset($rack_info[0]->shop_id)){
                    echo $rack_info[0]->shop_id;
                }  
